...
<body>
    		...
    		<div class="col-sm-10">
    			<div class="l-box l-box-yellow">
					...
					<tr class="tr_content">
						...
						<td class="state"><s:property value="state_str" /></td>
						<td>
						<s:if test="state==0">
							<a href="javascript:;" onclick="accept(<s:property value='id' />)">通过</a>　
				...
				<div class="tf_pagination style3 l-pagination l-pagination-yellow">
                    <div class="inner">
                        <a id="page-prev" class="page_prev" href="toHouseAdmin.action?page=1"><span>&lsaquo;</span></a>
						<!-- 动态生成，或者就这样，然后生成下前一页后一页的链接 -->
						<a id="page-1" href="toHouseAdmin.action?page=1" class="page-numbers">1</a>
                        <a id="page-2" href="toHouseAdmin.action?page=2" class="page-numbers">2</a>
                        <a id="page-3" href="toHouseAdmin.action?page=3" class="page-numbers">3</a>
			            <a id="page-next" class="page_next" href="toHouseAdmin.action?page=2"><span>&rsaquo;</span></a>
                    </div>
                </div>
    		</div>
    	</div>
    ...
    <script type="text/javascript" src="../js/user/house-manage.js"></script>
</body>
</html>