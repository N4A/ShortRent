	...
	<div class="body_wrap">
		<div class="container">
			...
			<div class="content " role="main">
				...
				<form id="newRoomForm" action="newHouse" method="post"
						...
						<div class="col-sm-4 ">
							...
							<div class="form-wrapper boxed-green">
								<span><input type="text" id="name" name="ho.name"
									...
									type="text" id="dayPrice" name="dayPrice" placeholder="日租价(必填)">
									<div id="showMessage2">&nbsp;</div>
								</span> <span> <textarea cols="27" rows="2" id="address"
										name="ho.address" placeholder="详细地址(必填)"></textarea>
						...
						<div class="col-sm-4">
							<div class="form-wrapper boxed-yellow">
								...
								<span> <textarea cols="27" rows="2" id="useRule"
										name="ho.useRule" placeholder="使用规则"></textarea> <span>&nbsp;</span>
								</span> <span> <textarea cols="27" rows="2" id="roomDesc"
										name="ho.roomDesc" placeholder="房间描述"></textarea> <span>&nbsp;</span>
								</span>
								<div class="input_styled inlinelist" id="bedType">
									...
									<div class="rowRadio">
										<label><input name="ho.bedType" type="radio" value="2" />双人床
										</label>
									</div>
									<div class="rowRadio">
										<label><input name="ho.bedType" type="radio" value="3" />高低床</label>
									</div>
								</div>
								...
								<div class="input_styled inlinelist" id="kind">
									...
									<div class="rowRadio">
										<label><input name="ho.kind" type="radio" value="2" />旅店
										</label>
									</div>
									<div class="rowRadio">
										<label><input name="ho.kind" type="radio" value="3" />客栈</label>
									</div>
									<div class="rowRadio">
										<label><input name="ho.kind" type="radio" value="4" />民居</label>
									</div>
								</div>
								<span> <input type="text" id="payRule" name="ho.payRule"
							...
							<div class="form-wrapper">
								<div class="row form-area boxed-red">
									<span> <textarea cols="27" rows="2" id="facility"
											name="ho.facility" placeholder="设施描述"></textarea> <span>&nbsp;</span>
									</span>
									<div class="input_styled inlinelist" id="bill">
										...
										<div class="rowRadio">
											<label><input name="ho.bill" type="radio" value="0" />不提供发票</label>
										</div>
									</div>
								...
								<div class="row button-area boxed-turquoise">
									...
									<a onclick="newRoom()" class="btn btn-blue but"><span>提交</span></a>
